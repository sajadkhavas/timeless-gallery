...
export const Route = createFileRoute("/journal/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "مقاله‌های تخصصی درباره‌ی ساعت‌سازی، نگهداری، راهنمای خرید و سبک زندگی.",
      },
          ...
          >
            ...
            <div>
              <p className="text-[10px] uppercase tracking-[0.4em] text-primary">
                {feature.category} ـ مقاله‌ی منتخب
              </p>
              <h2 className="mt-4 text-3xl font-medium leading-tight md:text-5xl group-hover:text-primary">
                {feature.title}
              </h2>
              <p className="mt-5 max-w-lg text-sm leading-relaxed text-foreground/65">
                {feature.excerpt}
              </p>
              <p className="mt-6 text-[11px] uppercase tracking-[0.3em] text-foreground/45">
                {feature.date} ـ {feature.readingTime}
              </p>
            </div>
          </Link>
        </div>
