      ...
      <div className="mx-auto max-w-7xl">
        <div className="reveal mb-12 space-y-6 md:max-w-2xl">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <Link to="/collections" className="group inline-flex items-center gap-3 bg-primary py-2.5 pl-3 pr-4 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90">
            ...
            <Link to="/about" className="text-sm font-medium text-foreground/80 underline-offset-8 hover:underline">
              درباره‌ی برند
            </Link>
          </div>
        </div>
...
const trustItems = [
  { title: "ضمانت اصالت مادام‌العمر", desc: "تمامی قطعات دارای شناسنامه‌ی بین‌المللی و کارت اصالت نوا هستند." },
  { title: "ارسال امن و بیمه‌شده", desc: "ارسال اختصاصی در سراسر ایران با بسته‌بندی ایمن و بیمه‌ی کامل." },
    ...
    <section className="px-6 py-24 md:py-32">
      <div className="mx-auto max-w-7xl">
        <div className="mb-14 flex items-end justify-between gap-4">
          ...
          <Link to="/collections" className="shrink-0 border-b border-primary/40 pb-1 text-xs font-medium hover:border-primary">
            مشاهده‌ی همه
          </Link>
        </div>
    ...
    <section className="border-t border-hairline px-6 py-24">
      <div className="mx-auto max-w-7xl">
        <div className="mb-14 flex items-end justify-between gap-4">
          ...
          <Link to="/shop" className="shrink-0 border-b border-primary/40 pb-1 text-xs font-medium hover:border-primary">
            تمام محصولات
          </Link>
        </div>
    ...
    <section className="bg-[oklch(0.18_0.003_60)] px-6 py-32 md:py-40">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-10 max-w-[52ch] text-pretty text-sm leading-loose text-foreground/55 md:text-base">
          ...
          آثاری را برمی‌گزینیم که توازنِ میان سنت و نوآوری را به کمال رسانده باشند.
        </p>
        <div className="mt-12 inline-flex items-center gap-3">
          <span className="h-px w-8 bg-primary/60" />
          <span className="text-[10px] uppercase tracking-[0.3em] text-foreground/50">نوا — تهران</span>
          <span className="h-px w-8 bg-primary/60" />
        </div>
      </div>
    </section>
    ...
    <section className="px-6 py-24">
      <div className="mx-auto max-w-7xl">
        <div className="mb-14 flex items-end justify-between gap-4">
          ...
          <Link to="/journal" className="shrink-0 border-b border-primary/40 pb-1 text-xs font-medium hover:border-primary">
            تمام مقاله‌ها
          </Link>
        </div>
          ...
          {ARTICLES.slice(0, 3).map((a) => (
            <Link key={a.slug} to="/journal/$slug" params={{ slug: a.slug }} className="group block">
              <div className="mb-5 overflow-hidden bg-surface">
                <img src={a.img} alt={a.title} loading="lazy" className="aspect-[4/3] w-full object-cover transition-transform duration-[1200ms] group-hover:scale-[1.03]" />
              </div>
